    ...
    <section id="what-we-build" className="bg-paper py-24 md:py-32">
      <div className="section-container">
        ...
        >
          ...
          <p className="mt-4 max-w-2xl text-lg text-ink-500">{t.services.subtitle}</p>
        </motion.div>
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between">
                  <span className="font-mono text-sm text-ink-500">{service.index}</span>
